...
import fall2018.csc2017.GameCentre.UserInterfaces.LeaderboardActivity;
...
public class PowersPlusGameActivity extends AppCompatActivity implements Observer, View.OnTouchListener {
     ...
     */
    private ArrayList<TextView> tileView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String message = String.format("Swipe to get the %dth power of %d!", power, base);
